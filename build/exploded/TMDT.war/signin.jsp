				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						...
						<div class="primari-box registered-account">
							<form class="new-account-box" id="accountLogin">
								<h3 class="box-subheading">Already registered?</h3>
								<div class="form-content">
									<div class="form-group primary-form-group">
										<label for="loginemail">Username</label>
										<input type="text" value="" name="email" v-model="formSignin.username" class="form-control input-feild">
									</div>
									<div class="form-group primary-form-group">
										<label for="password">Password</label>
										<input type="password" value="" name="password" v-model="formSignin.password" class="form-control input-feild">
									</div>
									<strong> <div class="alert alert-danger"  style=" display: none;   max-width: 270px;" v-show="errorSignin == true">{{messErrSignin}}
									</div></strong>
									...
									<div class="submit-button">
										<a v-on:click ="signin" id="signinCreate" class="btn main-btn">
										<span>
